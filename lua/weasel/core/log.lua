...
-- Modified again by Vhyrro for use with weasel :)
--
-- This library is free software; you can redistribute it and/or modify it
-- under the terms of the MIT license. See LICENSE for details.

--- @alias weasel.core.LogLevel
--- | "trace"
--- | "debug"
--- | "info"
--- | "warn"
...
--- @class (exact) weasel.log.configuration
...
--- @field level weasel.core.LogLevel                                          Any messages above this level will be logged.
--- @field modes ({ name: weasel.core.LogLevel, hl: string, level: number })[] Level configuration.
--- @field float_precision number                                  Can limit the number of decimals displayed for floats.

--- User configuration section
--- @type weasel.log.configuration
...
--- @param config weasel.log.configuration
--- @param standalone boolean
log.new = function(config, standalone)
  config = vim.tbl_deep_extend("force", default_config, config)
  config.plugin = "weasel" -- Force the plugin name to be weasel
